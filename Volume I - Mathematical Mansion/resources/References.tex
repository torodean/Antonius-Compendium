...
%	\bibitem{bib:PeriodicTable} Helmenstine, Todd. Periodic Table of the Elements. sciencenotes.org. 2015.
	...
	\bibitem{bib:Abstract Algebra} Judson T. W. "Abstract Algebra: Theory and Applications." Stephen F. Austin State University. August 5, 2017.
...
%	\bibitem{Nazarewicz_PHY802} Nazarewicz, Witek. "MSU PHY802 Lecture Slides." Survey of Nuclear Physics 802/492 Spring 2017. Michigan State University, n.d. Web. 31 Mar. 2017. 
	...
	\bibitem{bib:Elementary Analysis} Ross, Kenneth A. Elementary Analysis: The Theory of Calculus $2^{\textrm{nd}}$ edition. 
	...
	\bibitem{bib:elementTable} ``Table of Isotopic Masses and Natural Abundances." (n.d.): n. pag. NC State University. Web. \url{https://www.ncsu.edu/chemistry/msf/pdf/IsotopicMass_NaturalAbundance.pdf}. 
	...
	\bibitem{bib:DiffEQ} Zee, Dennis G. A first Course in Differential Equations with Modeling Applications." Edition 10. Book.
	
	\bibitem{bib:Taylor Error Analysis} Taylor, John R. (John Robert), 1939. An introduction to error analysis I John R. Taylor.-2nd ed.
	
	\bibitem{bib:feynman lectures} The Feynman Lectures on Physics, \url{https://www.feynmanlectures.caltech.edu/}

 	\bibitem{bib:IUPAC Periodic Table} IUPAC Periodic Table of the Elements and Isotopes. \url{https://applets.kcvs.ca/IPTEI/IPTEI.html}

  	\bibitem{bib:Table Of Nuclides} Table Of Nuclides.  Nuclear Data Center at KAERI. \url{https://atom.kaeri.re.kr/nuchart/}

   	\bibitem{bib:Modern Quantum Mechanics J.J Sakurai} Sakurai, J. J. (Jun John), 1933-1982. Modern quantum mechanics. - 2nd ed. I J.J. Sakurai, Jim Napolitano. p. cm. ISBN 978-0-8053-829 1-4 (alk. paper)

	\bibitem{bib:An Introduction To Underwater Acoustics} Xavier Lirton, An Introduction to Underwater Acoustics: Principals and Applications, Praxis Publishing, 2004.

	\bibitem{bib:Spacetime and Geometry} Sean M. Carroll, An Introduction to General Relativity: Spacetime and Geometry

 	\bibitem{bib:General Relativity, Black Holes, and Cosmology} Andrew J. S. Hamilton, General Relativity, Black Holes, and Cosmology, 13 January 2020
	
	\bibitem{bib:Newtons Scholium} Newton's Scholium on Time, Space, Place and Motion, \url{https://plato.stanford.edu/entries/newton-stm/scholium.html}

	\bibitem{bib:Being, Nothingness, and the Quantum Vacuum} Being, Nothingness, and the Quantum Vacuum: Revisiting Aether Through Heidegger's Lens, Douglas C. Youvan, March 13, 2024

	\bibitem{bib:The Michelson-Morley Experiment} The Michelson-Morley Experiment, Michael Fowler, UVa, \url{https://galileoandeinstein.phys.virginia.edu/lectures/michelson.html#Detecting%20the%20Aether%20Wind:%20the%20Michelson-Morley%20Experiment}

	\bibitem{bib:The_Speed_of_Light_in_the_Quantum_Vacuum_Aether_the_Equation_of_God} The Speed of Light in the Quantum Vacuum Aether: the "Equation of God", Toni Scarmato, May 2023,  \url{https://www.researchgate.net/profile/Toni-Scarmato/publication/371379815_The_Speed_of_Light_in_the_Quantum_Vacuum_Aether_the_Equation_of_God/links/6481e6c62cad460a1bfe15cc/The-Speed-of-Light-in-the-Quantum-Vacuum-Aether-the-Equation-of-God.pdf}

	\bibitem{bib: A First Course in Linear Algebra} A First Course in Linear Algebra, Robert A. Beezer, Version 3.4. \url{https://citeseerx.ist.psu.edu/document?repid=rep1&type=pdf&doi=2d126254474e43b7d300ef5e60752d5e19f287c3}
\end{thebibliography}
}
