...
Most forces in nature are represented by fields defined on \keyword{spacetime} (i.e. the electromagnetic field). General Relativity instead states that gravity is inherent in spacetime itself and thus what is experienced as \keyword{gravity} is simply a manifestation of the \keyword{curvature of spacetime} \cite{bib:Spacetime and Geometry}. General relativity is a theory of gravity.
...
\input{./chapters/relativity/general_relativity}
