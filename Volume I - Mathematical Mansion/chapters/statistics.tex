...
\begin{defn}[Probability (Relative Frequency)]{Probability}
...
\begin{defn}[Arithmetic Mean \label{Arithmetic Mean Definition}]{1}
	If $x_0, ..., x_N$ denotes N separate measurements of one quantity $x$, then we define the \keyword{arithmetic mean} (or average) $\bar{x}$ as
	\begin{align}
