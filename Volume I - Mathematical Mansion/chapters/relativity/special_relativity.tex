...
\keyword{Special relativity} is the simplest theory of spacetime which corresponds to general relativity in the absence of gravity (no-gravity limit). Special relativity can be derived from a relatively small number of postulates. These postulates are generally given in different forms depending on the source and writer. From one source \cite{bib:General Relativity, Black Holes, and Cosmology}, the postulates follow as
